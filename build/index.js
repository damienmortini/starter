...
System.registerDynamic("npm:webcomponents.js@0.7.20/webcomponents", ["github:jspm/nodelibs-process@0.1.2"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.registerDynamic("npm:webcomponents.js@0.7.20", ["npm:webcomponents.js@0.7.20/webcomponents"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = $__require('npm:webcomponents.js@0.7.20/webcomponents');
  global.define = __define;
  return module.exports;
});

System.register("npm:dlib@0.0.2/dom/CustomElement", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/object/create", "npm:webcomponents.js@0.7.20"], function (_export) {
  ...
  return {
    ...
    }, function (_npmWebcomponentsJs0720) {}],
    execute: function () {
      /* */
      "use strict";
...
System.register("src/index.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/object/assign", "npm:dlib@0.0.2/dom/CustomElement", "src/template.html!github:systemjs/plugin-text@0.0.2"], function (_export) {
  ...
  return {
    ...
    execute: function () {
      ...
      DnitMain = (function (_CustomElement) {
        _inherits(DnitMain, _CustomElement);
